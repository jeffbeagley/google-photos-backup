...
config.oAuthClientID = process.env.OAUTH_CLIENT_ID || 'ADD YOUR CLIENT ID';

// The OAuth client secret from the Google Developers console.
config.oAuthclientSecret = process.env.OAUTH_CLIENT_SECRET || 'ADD YOUR CLIENT SECRET';
...
config.photosPageSize = 100; //100 is max
